import { bus } from './bus.js?v=20260808c';
import { jsonAdapter } from '../data/adapters/jsonAdapter.js?v=20260808c';
import { loadPersistedState, savePersistedState, clearPersistedState } from './persistence.js?v=20260808c';
import { seedSectionAllocation } from '../optimize/allocationSeed.js?v=20260808c';
