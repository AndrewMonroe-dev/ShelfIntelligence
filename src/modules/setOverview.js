...
export function mount(el) {
  ...
  function render() {
    ...
    // Andrew, 2026-08-07: auto-regenerate whenever missing or stale (any
    // plan-generation input changed since currentPlan was last generated) --
    // safe here since this page only reads the plan, nothing on it is
    // hand-edited.
