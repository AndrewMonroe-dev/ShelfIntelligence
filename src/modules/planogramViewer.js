...
import { getPhysicalWidthFt, BAY_WIDTH_FT, buildSectionShelves } from '../optimize/shelfPosition.js?v=20260807b';
import { sectionForSku } from '../optimize/blocking.js?v=20260807b';
import { bottleWidthInches } from '../optimize/facings.js?v=20260807b';
...
function buildBayEntry(sku, facings, bottleDimensions, scoreMap, shelfDef, isLocked = true) {
  ...
  return {
    sku: {
      ...
      strategicSupplierRank: sku.strategicSupplierRank,
      strategicSupplierTier: sku.strategicSupplierTier,
